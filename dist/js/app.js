...
var githubApiKey = exports.githubApiKey = 'c20ecc1adb542c08dc5f826711daad64b7c717b6';
...
var userDataEl = document.querySelector('.user-data.column-container');
var questEl = document.querySelector('.quest');
var userLogin = 'cr0wbait';
var grabUserData = _jquery2.default.getJSON('https://api.github.com/users/' + userLogin);
var grabUserRepos = _jquery2.default.getJSON('https://api.github.com/users/' + userLogin + '/repos');
...
questEl.addEventListener('keydown', function (evt) {
  if (evt.keyCode === 13) {
    var questStr = questEl.value;
    window.location.hash = questStr;
    userLogin = questStr;

    _jquery2.default.when(grabUserData, grabUserRepos).then(function (data1, data2) {
      var htmlShape = userHtmlShape(data1[0], data2[0]);
    });
  }
});
