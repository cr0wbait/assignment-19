...
var grabUserData = _jquery2.default.getJSON('https://api.github.com/users/' + nowRoute + '?access_token=' + _secrets.githubApiKey);
var grabUserRepos = _jquery2.default.getJSON('https://api.github.com/users/' + nowRoute + '/repos?access_token=' + _secrets.githubApiKey);
...
questEl.addEventListener('keydown', function (evt) {
  if (evt.keyCode === 13) {
    ...
    var _nowRoute = window.location.hash.slice(1);
    var _grabUserData = _jquery2.default.getJSON('https://api.github.com/users/' + _nowRoute + '?access_token=' + _secrets.githubApiKey);
    var _grabUserRepos = _jquery2.default.getJSON('https://api.github.com/users/' + _nowRoute + '/repos?access_token=' + _secrets.githubApiKey);
    _jquery2.default.when(_grabUserData, _grabUserRepos).then(function (data1, data2) {
